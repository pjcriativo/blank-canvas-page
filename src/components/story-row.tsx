  ...
  return (
    <section className="mt-12 sm:mt-16">
      ...
      <div className="relative mt-6 hidden px-8 sm:block lg:px-12">
        <div ref={desktopRef} className="group/row relative overflow-x-hidden overflow-y-visible pt-3">
          <div
          ...
          >
            {Array.from({ length: totalPages }).map((_, pageIdx) => (
              <div
                key={pageIdx}
                className="grid w-full shrink-0 grid-cols-5 gap-5 pb-4 lg:gap-6"
              >
                {stories
