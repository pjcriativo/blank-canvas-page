...
export function HeroBanner({ banner, story }: Props) {
  ...
  const headline = language === "pt-BR" ? banner.headline || localizedStory.title : localizedStory.title;
  const subline = language === "pt-BR" ? banner.subline || localizedStory.subtitle : localizedStory.subtitle;
  return (
