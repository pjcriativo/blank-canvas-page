  ...
  return (
    ...
    >
      ...
      <fieldset className="mt-5 rounded-xl bg-background/35 p-4 ring-1 ring-inset ring-white/[0.05]">
        ...
        <div role="radiogroup" aria-label={copy.addressStyleLabel} className="mt-2 grid gap-2 sm:grid-cols-2">
          <label
          ...
          >
            ...
            <span className="text-xs italic text-muted-foreground">{copy.addressStyleNamePreview}</span>
          </label>
          <label
            className={`flex cursor-pointer flex-col gap-1 rounded-lg border p-3 transition ${
              addressStyle === "you"
          ...
          >
            ...
            <span className="text-xs italic text-muted-foreground">{copy.addressStyleYouPreview}</span>
          </label>
        </div>
