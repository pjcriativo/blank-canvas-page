    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="font-display text-sm font-bold text-foreground">
          Instale pelo celular
        </p>
        <p className={cn("mt-0.5 text-xs leading-relaxed text-muted-foreground", compact && "line-clamp-2")}>
          Para adicionar à tela inicial, abra o Reino das Cores no navegador do seu celular. Você pode ver os passos aqui mesmo.
        </p>
      </div>
    </div>
  );
        ...
        {stage === "choose" && (
          <div className="p-6 sm:p-8">
            ...
            {!env.isDesktop && !env.platform && (
              ...
              >
                Não conseguimos identificar seu navegador automaticamente. Escolha abaixo para ver os passos certos.
              </div>
            )}
            <DialogHeader className="space-y-2">
            ...
            <p className="mt-4 text-center text-[11px] text-muted-foreground">
              Não tem certeza? Toque em <span className="font-semibold text-foreground">iPhone</span> se for um aparelho da Apple, ou <span className="font-semibold text-foreground">Android</span> nos demais.
            </p>
          </div>
        )}
