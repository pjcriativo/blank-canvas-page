...
function vectorizeRegion(
  ...
  while (iter++ < maxIter) {
    ...
    let nextDir = dir;
    switch (code) {
      case 1: nextDir = 2; break; // SW
      case 2: nextDir = 1; break; // SE
      case 3: nextDir = 2; break; // SW+SE
      case 4: nextDir = 0; break; // NE
      case 5: nextDir = dir === 1 ? 2 : 0; break; // NE+SW (saddle)
      case 6: nextDir = 1; break; // NE+SE
      case 7: nextDir = 2; break; // NE+SE+SW
      case 8: nextDir = 3; break; // NW
      case 9: nextDir = 3; break; // NW+SW
      case 10: nextDir = dir === 0 ? 3 : 1; break; // NW+SE (saddle)
      case 11: nextDir = 3; break; // NW+SW+SE
      case 12: nextDir = 0; break; // NW+NE
      case 13: nextDir = 0; break; // NW+NE+SW
      case 14: nextDir = 1; break; // NW+NE+SE
      default: nextDir = dir; // 0 e 15 não devem acontecer no contorno
    }
