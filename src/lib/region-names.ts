...
const LABEL_TRANSLATIONS: Record<Exclude<RegionLanguage, "pt-BR">, Record<string, string>> = {
  "en-US": {
    jesus: "Jesus", maria: "Mary", jose: "Joseph", bebe: "Baby Jesus", davi: "David",
    golias: "Goliath", noe: "Noah", ester: "Esther", rei: "King", pastor: "Shepherd",
    pai: "Father", filho: "Son", samaritano: "Good Samaritan", viajante: "Traveler",
    semeador: "Sower", criancas: "Child",
    pomba: "Dove", ovelha: "Sheep", leao: "Lion", camelo: "Camel", baleia: "Whale",
    peixe: "Fish", passaro: "Bird", elefante: "Elephant", girafa: "Giraffe",
    sol: "Sun", lua: "Moon", estrela: "Star", nuvem: "Cloud", "arco-iris": "Rainbow",
    chuva: "Rain", ceu: "Sky", mar: "Sea", montanha: "Mountain", colina: "Hill",
    arvore: "Tree", palmeira: "Palm tree", grama: "Grass", flor: "Flower",
    folha: "Leaves", rocha: "Rock", chao: "Ground",
    arca: "Boat", casa: "House", tenda: "Tent", estabulo: "Stable", telhado: "Roof",
    porta: "Door", janela: "Window", poco: "Well", cesto: "Basket", pao: "Bread",
    rolo: "Scroll", tabua: "Tablet", coroa: "Crown", cajado: "Staff", lampada: "Lamp",
    coracao: "Heart",
    detalhe: "Detail",
  },
  "es-ES": {
    jesus: "Jesús", maria: "María", jose: "José", bebe: "Bebé Jesús", davi: "David",
    golias: "Goliat", noe: "Noé", ester: "Ester", rei: "Rey", pastor: "Pastor",
    pai: "Padre", filho: "Hijo", samaritano: "Buen samaritano", viajante: "Viajero",
    semeador: "Sembrador", criancas: "Niño",
    pomba: "Paloma", ovelha: "Oveja", leao: "León", camelo: "Camello", baleia: "Ballena",
    peixe: "Pez", passaro: "Pájaro", elefante: "Elefante", girafa: "Jirafa",
    sol: "Sol", lua: "Luna", estrela: "Estrella", nuvem: "Nube", "arco-iris": "Arcoíris",
    chuva: "Lluvia", ceu: "Cielo", mar: "Mar", montanha: "Montaña", colina: "Colina",
    arvore: "Árbol", palmeira: "Palmera", grama: "Hierba", flor: "Flor",
    folha: "Hojas", rocha: "Roca", chao: "Suelo",
    arca: "Barco", casa: "Casa", tenda: "Tienda", estabulo: "Establo", telhado: "Tejado",
    porta: "Puerta", janela: "Ventana", poco: "Pozo", cesto: "Cesta", pao: "Pan",
    rolo: "Rollo", tabua: "Tabla", coroa: "Corona", cajado: "Cayado", lampada: "Lámpara",
    coracao: "Corazón",
    detalhe: "Detalle",
  },
};
...
const RULES: Rule[] = [
  ...
  { keywords: ["-c1-", "-c2-", "-c3-", "child"], region: { key: "criancas", label: "Criança", emoji: "🧒" } },

  // ─── Animais ─────────────────────────────────────────────────────────
  { keywords: ["dove", "pomba"], region: { key: "pomba", label: "Pomba", emoji: "🕊️" } },
  { keywords: ["sheep", "ovelha", "lamb", "rebanho"], region: { key: "ovelha", label: "Ovelha", emoji: "🐑" } },
  ...
  { keywords: ["bird", "passaro", "pass"], region: { key: "passaro", label: "Pássaro", emoji: "🐦" } },
  { keywords: ["elephant", "elefante"], region: { key: "elefante", label: "Elefante", emoji: "🐘" } },
  ...
  { keywords: ["rainbow", "-rb-", "arco"], region: { key: "arco-iris", label: "Arco-íris", emoji: "🌈" } },
  ...
  { keywords: ["ground", "terra", "yard", "@bare-g"], region: { key: "chao", label: "Chão", emoji: "🟫" } },

  // ─── Construções/objetos ─────────────────────────────────────────────
  { keywords: ["ark", "arca", "boat", "barco", "hull"], region: { key: "arca", label: "Barco", emoji: "🚢" } },
  ...
  { keywords: ["heart", "coracao", "abraco", "amor", "@bare-h"], region: { key: "coracao", label: "Coração", emoji: "❤️" } },
];
