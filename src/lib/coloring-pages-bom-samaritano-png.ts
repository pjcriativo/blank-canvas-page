...
export function generateBomSamaritanoPngPages(): string[] {
  const realPages = [
    samPage01, samPage02, samPage03, samPage04, samPage05,
    samPage06, samPage07, samPage08, samPage09, samPage10,
    samPage11, samPage12, samPage13, samPage14, samPage15,
    samPage16, samPage17, samPage18, samPage19, samPage20,
    samPage21, samPage22, samPage23, samPage24, samPage25,
    samPage26, samPage27, samPage28, samPage29, samPage30,
  ];
