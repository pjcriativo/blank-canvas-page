 ...
 */
function pick(copy: Copy, language: AppLanguage, name: string, style: AddressStyle = "name"): string {
...
export const pageCompleteBody = (
  ...
  pick(
    {
      "pt-BR": {
        generic: "Você pintou todos os elementos desta página. Continue pintando para concluir a história!",
        named: "{name}, você pintou todos os elementos desta página. Continue para concluir a história!",
      },
      "en-US": {
      ...
      "es-ES": {
        generic: "Coloreaste todos los elementos de esta página. ¡Sigue pintando para terminar la historia!",
        named: "{name}, coloreaste todos los elementos de esta página. ¡Sigue para terminar la historia!",
      },
    },
    language,
    name,
...
export const pageCompleteToast = (
  ...
  pick(
    {
      "pt-BR": { generic: "Boa! Mais uma página pintada!", named: "Boa, {name}! Mais uma página pintada!" },
      "en-US": { generic: "Nice! Another page colored!", named: "Nice, {name}! Another page colored!" },
      "es-ES": { generic: "¡Bien! ¡Otra página coloreada!", named: "¡Bien, {name}! ¡Otra página coloreada!" },
    },
    language,
    name,
    style,
