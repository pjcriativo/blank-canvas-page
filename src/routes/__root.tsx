  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-cream px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display text-4xl font-extrabold text-foreground">Página não encontrada</h1>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Reino das Cores: um app infantil cristão para colorir histórias bíblicas." },
      { property: "og:description", content: "Reino das Cores: um app infantil cristão para colorir histórias bíblicas." },
      { name: "twitter:description", content: "Reino das Cores: um app infantil cristão para colorir histórias bíblicas." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9b974c4f-4062-4d55-8702-7b17546b3b29/id-preview-8b511815--b7a69e9c-4f5b-461f-8a69-70a7178a6263.lovable.app-1776651967672.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9b974c4f-4062-4d55-8702-7b17546b3b29/id-preview-8b511815--b7a69e9c-4f5b-461f-8a69-70a7178a6263.lovable.app-1776651967672.png" },
    ],
    links: [
