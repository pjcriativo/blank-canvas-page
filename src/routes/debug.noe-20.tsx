    ...
    <div className="min-h-screen bg-background p-6">
      <header className="max-w-6xl mx-auto text-center space-y-2 mb-8">
        ...
        <p className="text-sm text-muted-foreground">
          Revise as 20 páginas. Se aprovar, me avisa que eu construo o motor de pintura novo
          (balde + pincel) e integro tudo na rota real <code>/colorir/noe-e-a-arca</code>.
        </p>
      </header>
      ...
      <footer className="max-w-3xl mx-auto text-sm text-muted-foreground space-y-2 pt-8 mt-8 border-t border-foreground/10">
        ...
        <p>
          <strong>Fase 2:</strong> depois que você testar a Arca de Noé funcionando 100%, eu
          replico o mesmo padrão nas outras 9 histórias (mais 180 imagens).
        </p>
      </footer>
    </div>
  );
