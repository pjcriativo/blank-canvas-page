...
import { BarChart3, Eye, Globe2, ImageIcon, LayoutDashboard, LogOut, Mail, PlugZap, ScanSearch, Users } from "lucide-react";
...
const NAV: Array<{
  to: "/admin" | "/admin/usuarios" | "/admin/relatorios" | "/admin/branding" | "/admin/emails" | "/admin/qa-capas" | "/admin/idiomas" | "/admin/integracoes";
  labelKey: "dashboard" | "users" | "reports" | "branding" | "emailTemplates" | "qaCovers" | "languages" | "webhooks";
      ...
      <div className="flex min-h-screen w-full flex-col md:flex-row">
        <aside className="sticky top-0 z-20 border-b border-border bg-card/95 backdrop-blur-xl md:h-screen md:w-72 md:shrink-0 md:border-b-0 md:border-r">
          ...
          <nav className="flex gap-2 overflow-x-auto px-3 pb-3 md:flex-col md:overflow-visible md:px-4">
            ...
            <Link to="/home" target="_blank" rel="noopener noreferrer" className="flex shrink-0 items-center gap-3 rounded-2xl px-4 py-3 text-sm font-bold text-muted-foreground transition hover:bg-accent hover:text-foreground">
